...
const songs = [ 
    {
        ...
        image:"canciones/portada1.png",
        author: "U2",
        path: "canciones/U2 - With Or Without You (Official Music Video) (320).mp3",
    },
      {
        name: "Tacones Rojos",
        image:"canciones/portada2.png",
        author: "Sebastián Yatra",
        path: "canciones/Sebastián Yatra - Tacones Rojos (Official Video) (320).mp3",
      },
      {
          name: "Ojos Marrones",
        image:"canciones/portada3.png",
        author: "Lasso",
        path: "canciones/Lasso - Ojos Marrones (Video Oficial) Parte 1 (320).mp3",
      },
      {
         name: "La historia de Juana",
         image:"canciones/portada4.png",
         author: "Benji Cordero",
         path: "canciones/La Historia De Juana (320).mp3",
     }
    //   {
